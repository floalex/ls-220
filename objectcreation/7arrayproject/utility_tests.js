// This is similar to http://underscorejs.org/
...
// define the test in business logic, which initially should fail before the function exists
...
test("pick ignores any properties passed in that do not exist on the source object", function() {
  ...
  return !Object.prototype.hasOwnProperty.call(_(new_obj).pick("foo", "bar"), "bar")
});

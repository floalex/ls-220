...
// Lastly, the plain JavaScript's template property has to be converted to a template 
// rendering method that returns HTML when passed an object. Likewise, the call to adding 
// a new row of data has to be changed to be rendered with the method.
(function() {
  inventory = {
    last_id: 0,
    collection: [],
    ...
    // Caches/stores the template method
    ...
    // Loads a new <tr> element with the correct attributes based on id
